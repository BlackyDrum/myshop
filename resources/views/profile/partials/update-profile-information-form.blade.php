<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="forename" name="forename" type="text" class="mt-1 block w-full" :value="old('forename', $user->forename)" required autofocus autocomplete="forename" />
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        {{ __('Ihre E-Mail-Adresse wurde noch nicht verifiziert.') }}
